    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                ...
                <h3 class="fw-bold mb-0 text-success">+ {{ number_format($invoices->sum('price_difference'), 0) }} ر.س</h3>
            </div>
        </div>
                        ...
                        <tbody>
                            @forelse($invoices as $invoice)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-center fw-bold text-success">+ {{ number_format($invoice->price_difference, 0) }}</td>
