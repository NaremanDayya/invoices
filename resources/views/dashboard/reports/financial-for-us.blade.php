...
@section('title', 'تحصيل مالي - لنا')
@section('page_title', 'التقارير - فروقات مالية (لنا)')
@section('page_subtitle', 'عرض الفواتير التي يوجد بها فروقات سعر لصالحنا')
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                <p class="text-muted small mb-1">إجمالي الفروقات (لنا)</p>
                <h3 class="fw-bold mb-0 text-success">+ {{ number_format($invoices->sum('price_difference'), 2) }} ر.س</h3>
            </div>
        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="px-4 py-3 border-0 text-center">فرق السعر (لنا)</th>
                        ...
                        <tbody>
                            @forelse($invoices as $invoice)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-center fw-bold text-success">+ {{ number_format($invoice->price_difference, 2) }}</td>
