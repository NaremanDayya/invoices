...
@push('scripts')
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const exportDropdown = document.getElementById('exportInvoiceDropdown');
                    if (exportDropdown) {
                        // PDF Export
                        document.querySelectorAll('.export-pdf').forEach(button => {
                            button.addEventListener('click', function(e) {
                                e.preventDefault();
                                exportToPDF('export-invoice-content', 'فواتير_التقرير');
                            });
                        });
                        ...
                        document.querySelectorAll('.export-excel').forEach(button => {
                            button.addEventListener('click', function(e) {
                                e.preventDefault();
                                exportToExcel('invoices-table', 'فواتير_التقرير');
                            });
                        });
                    }
                    ...
                    function exportToPDF(elementId, filename) {
                        ...
                        const opt = {
                            ...
                            html2canvas: {
                                ...
                                onclone: function(clonedDoc) {
                                    ...
                                    clonedDoc.body.style.fontFamily = "'Segoe UI', 'Arial', sans-serif";
                                }
                            },
                            jsPDF: {
                                unit: 'mm',
                        ...
                        element.innerHTML = '<div style="text-align: center; padding: 50px;">جاري تحضير ملف PDF...</div>';
