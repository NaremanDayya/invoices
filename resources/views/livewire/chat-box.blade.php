<div class="invoice-chat-messages">
                ...
                <div class="message-bubble {{ $isSender ? 'sent-bubble' : 'received-bubble' }}">
                    ...
                    @if($message->message === 'like')
                        <div class="like-message">
                            ...
                            <span>Liked the conversation</span>
                        </div>
                    @else
    ...
    <!-- Load More Button -->
    @if($loadedMessages && $loadedMessages->count() >= $paginate_var)
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const messageInput = document.querySelector('[wire\\:model="message"]');
            ...
            messageInput.addEventListener('input', function() {
                ...
                // Show typing indicator after 1 second of typing
